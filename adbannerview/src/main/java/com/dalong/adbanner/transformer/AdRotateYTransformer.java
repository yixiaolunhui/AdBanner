 ...
 */
public class AdRotateYTransformer extends AdBasePageTransformer {

    private static final float DEFAULT_MAX_ROTATE = 35f;

    private float mMaxRotate = DEFAULT_MAX_ROTATE;

    public AdRotateYTransformer() {
    }
    public AdRotateYTransformer(float maxRotate) {
        this(maxRotate, AdNonPageTransformer.INSTANCE);
    }

    public AdRotateYTransformer(ViewPager.PageTransformer pageTransformer) {
        this(DEFAULT_MAX_ROTATE, pageTransformer);
    }

    public AdRotateYTransformer(float maxRotate, ViewPager.PageTransformer pageTransformer) {
